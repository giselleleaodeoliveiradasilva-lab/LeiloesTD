...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try {
            int idProdutoInt = Integer.parseInt(idString);
            ProdutosDAO produtosdao = new ProdutosDAO();

            produtosdao.venderProduto(idProdutoInt);
            listarProdutos();
            id_produto_venda.setText("");
        }catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null,"Erro:O ID deve ser um numero inteiro valido ");
            
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,"Erro ao tentar vender produto:"+e.getMessage());
        }
